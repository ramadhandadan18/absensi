        ...
        <form action="<?php print site_url(); ?>phpspreadsheet/upload" class="excel-upl" id="excel-upl" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            <div class="row padall">
                <div class="col-lg-6 order-lg-1">
                    ...
                    <input type="file" class="custom-file-input" id="inputGroupFile04" name="fileURL" required>
                    <label class="custom-file-label" for="inputGroupFile04">Choose file...</label>
                    <!-- <label for="validatedCustomFile">Example file input</label>
           <input type="file" class="form-control-file" id="validatedCustomFile"> -->
                </div>
